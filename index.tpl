            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    <li>
                                        <a href="#" onClick="$('.request-example-curl').each(function(){$(this).addClass('active')});$('.request-example-http').each(function(){$(this).removeClass('active')});">cURL</a>
                                    </li>
                                    <li>
                                        <a href="#" onClick="$('.request-example-curl').each(function(){$(this).removeClass('active')});$('.request-example-http').each(function(){$(this).addClass('active')});">HTTP</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <a href="#doc-api-detail">
                        <hr class="clear" id="doc-api-detail">
                    </a>
                    ...
                    <div class="endpoints-group ">
                        ...
                        <div class="request">
                            <div class="col-md-7">
                                ...
                                <hr class="clear"> {{ with $req.Responses }}
                                <div>
